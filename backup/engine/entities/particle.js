...
export default class particle {
  ...
  render(ctx) {
    ...
    ctx.lineStyle = this.style.lineStyle || undefined;
    ctx.shadowBlur = this.style.shadowBlur || undefined;
    ctx.shadowColor = this.style.shadowColor || undefined;
    ctx.shadowOffsetX = this.style.shadowOffsetX || undefined;
    ctx.shadowOffsetY = this.style.shadowOffsetY || undefined;
    // Draw the particle
